...
const CoinPage = () => {
    ...
    return <div className='w-4/5 m-auto px-8 shadow-lg '>
        <div className='flex py-9 mt-9'>
        ...
        <div className='grid md:grid-cols-2 gap-8'>
            <div>
                <div className='flex justify-between'>
                    {coin?.market_data?.current_price ? (<p className='text-3xl font-bold'>${coin.market_data.current_data?.current_price.usd.toLocaleString()}</p>) : null}
                    <p>7 Day</p>
                </div>
                <div>
            ...
            <div>
                ...
                <div className='flex justify-between py-4'>
                    ...
                    <div>
                        <p className='text-gray-500 text-sm'>Price Change (14h)</p>
